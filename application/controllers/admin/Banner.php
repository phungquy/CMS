    ...
    public function add()
    {
        ...
        if (isset($_POST['banner_status'])) {
            ...
            switch ($this->input->post('banner_type')) {
                case 1:
                    $fields = 'banner_picture';$value_fields = $_FILES['banner_picture']['name'];$value_fields = preg_replace('/([\s]+)/', '-', $value_fields);
                    // $fields = 'banner_picture';$value_fields = preg_replace('/([\s]+)/', '-', $_FILES['banner_picture']['name']);
                    break;
                case 2:
		            ...
		            if ($error == true) {
		            	...
		            	if ($this->_data['formData']['banner_type'] == 1) {
		            		if ($_FILES['banner_picture']['name'] != '') {
                                ...
                                $this->_data['formData']['banner_picture'] = preg_replace('/([\s]+)/', '-', $this->_data['formData']['banner_picture']);
