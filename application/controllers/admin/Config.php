    ...
    public function add()
    {
        ...
        if (isset($_POST['config_name'])) {
        	...
        	$this->_data['formData'] = array(
	        	...
	        	'config_all' => $this->input->post('config_all'),
    	...
    	if (is_numeric($id) && $id > 0) {
    		...
    		if ($myConfig && $myConfig['id'] > 0) {
		        ...
		        $this->_data['formData'] = array(
		        	...
		        	'config_all' => $myConfig['config_all']
		        );
    ...
    public function logo_favion()
    {
        ...
        if (isset($_FILES['logo']) && $_FILES['logo']['name'] != "") {
            ...
            if ($upload_logo) {
                $notify = array(
                    'title' => lang('success'), 
                    'text' => 'Logo '.lang('edited').' | '.lang('please').'Ctrl+F5',
                    'type' => 'success'
                );
            } else {
                $notify = array(
        ...
        if (isset($_FILES['favicon']) && $_FILES['favicon']['name'] != "") {
            ...
            if ($upload_favicon) {
                $notify = array(
                    'title' => lang('success'), 
                    'text' => 'Favicon '.lang('edited').' | '.lang('please').'Ctrl+F5',
                    'type' => 'success'
                );
            } else {
                $notify = array(
