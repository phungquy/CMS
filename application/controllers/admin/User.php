...
class User extends MY_Controller {
    ...
    public function add()
    {
        ...
        if (isset($_POST['user_username'])) {
            ...
            do {
                ...
                if ($group == 1) {
                    if ($this->mpermission->permission("user_administrator",$this->_data['user_active']['active_user_group']) != true) {
                       $text = lang('notpermissionadmin');$error = true;break;
                    }
                }
            } while (0);
            if ($error == true) {
    ...
    public function edit($id)
    {
        ...
        if (is_numeric($id) && $id > 0) {
            ...
            if ($myUser['user_group'] == 1 && $this->_data['user_active']['active_user_group'] != 1) {
