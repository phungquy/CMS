	...
	<div class="login-page">
		<div class="form">
			<form class="login-form" method="post">
				...
				<h2 style="color: #95a5a6;">Quên mật khẩu</h2>
				<input type="email" name="email" value="<?= $formData['email']?>" required="required" placeholder="Nhập email của tài khoản"/>
				<input type="hidden" name="<?= $token_name?>" value="<?= $token_value?>">
				<button type="submit" name="fsend">Gửi</button>
