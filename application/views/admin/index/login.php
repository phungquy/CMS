	...
	<div class="login-page">
		<div class="form">
			<form class="login-form" method="post">
				...
				<!-- <input type="text" name="username" value="demo" required="required" placeholder="Tên đăng nhập"/> -->
				<!-- <input type="password" name="password" value="Demo@123456" required="required" placeholder="Mật khẩu"/> -->
