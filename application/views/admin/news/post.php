          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <div class="form-group">
                ...
                <label class="control-label col-md-5 col-sm-5 col-xs-12" for="news_category"><?= lang('category')?> hiển thị</label>

                <div class="col-md-7 col-sm-7 col-xs-12">

                  <select class="form-control multiselect-ui" name="news_secondary_category[]" multiple>
          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <?php if ($formData['news_picture'] != ''): ?>
                ...
                <img src="<?= my_library::base_file().'news/'.$id.'/'.$formData['news_picture']?>" id="current-image" alt="<?= lang('typicalphoto')?>" style="width: 320px;height: auto;max-height: 100%;margin-left: 3px; margin-bottom: 10px;position: absolute;">
