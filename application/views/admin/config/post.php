        ...
        <div class="col-md-8 col-sm-8 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <div class="form-group">
                <label class="col-md-3 col-sm-3 col-xs-12 control-label"><?= lang('limit')?>
                </label>
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" name="config_all" value="1" class="flat" <?= $formData['config_all'] == 1 ? 'checked="checked"' : '';?>> <?= lang('allpage')?>
                    </label>
                  </div>
                </div>
              </div>
