						...
						<div class="x_content">
							<div class="" role="tabpanel" data-example-id="togglable-tabs">
								<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
									...
									<li role="presentation" class=""><a href="#cache" role="tab" id="cache-tab" data-toggle="tab" aria-expanded="false">Cache</a>
									</li>
								</ul>
								<div id="myTabContent" class="tab-content">
									...
									<div role="tabpanel" class="tab-pane fade" id="cache" aria-labelledby="cache-tab">
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12" for="use_cache"> Cache
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="checkbox" name="use_cache" class="js-switch" value="1" <?= $formData['use_cache'] == 1 ? 'checked' : ''?>/>
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-md-3 col-sm-3 col-xs-12" for="time_cache"><?= lang('timecache')?> (s)
											</label>
											<div class="col-md-6 col-sm-6 col-xs-12">
												<input type="number" name="time_cache" min="0" class="form-control col-md-7 col-xs-12" value="<?= $formData['time_cache']?>">
											</div>
										</div>
									</div>
								</div>
