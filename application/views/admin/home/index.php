<div class="right_col" role="main">
  <div class="row tile_count">
    ...
    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
      <span class="count_top"><i class="fa fa-briefcase"></i> <?= lang('brief')?></span>
      <div class="count"><?= $totalBrief?></div>
      <span class="count_bottom"><i class="red"><?= $recordnotprocess?> </i> <?= lang('unprocessor')?></span>
    </div>
    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
