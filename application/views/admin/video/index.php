							...
							<tbody>
								<?php if (!empty($list)): ?>
									<?php foreach ($list as $value): ?>
										...
										$linkEdit = my_library::admin_site().'video/edit/'.$value['id'];
											...
											<td><?= $value['video_name']?>
												<div style="height: 20px;">
													<div class="actionhover">
														<a href="<?= $linkEdit.'?lang='.$flanguage['lang_code']?>" class="text-primary"><?= lang('edit')?></a> | <a href="javascript:;" onclick="confirm_delete(<?= $value['id']?>)" class="text-danger"><?= lang('delete')?></a>
													</div>
												</div>
											</td>
