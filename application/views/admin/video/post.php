            ...
            <div class="x_content">
              <div class="form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 item">
                  <input id="video_name" class="form-control col-md-7 col-xs-12" maxlength="<?= $mySetting['limit_title']?>" name="video_name" required="required" type="text" value="<?= $formDataLang['video_name']?>">
                </div>
              </div>
              <?php if (isset($formDataLang['video_alias']) && isset($id)): ?>
                <div class="form-inline" style="margin-left: 10px;">
                  <div class="form-group">
                    ...
                    <div>
                      <input type="text" class="form-control" id="video_alias" name="video_alias" maxlength="<?= $mySetting['limit_title']?>" value="<?= $formDataLang['video_alias']?>" style="max-width: 100%;width: 350px;">
                      <cite>-video<?= $id?>.html</cite>
                    </div>
                  </div>
                </div>
              <?php endif ?>
          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              <?php if ($formData['video_picture'] != ''): ?>
                ...
                <img src="<?= my_library::base_file().'video/'.$id.'/'.$formData['video_picture']?>" id="current-image" alt="<?= lang('typicalphoto')?>" style="width: 320px;height: auto; margin-bottom: 10px;position: absolute;">
              <?php else: ?>
                <button type="button" class="btn btn-success btn-xs" data-target="#modal" data-toggle="modal">
                  <?= lang('addphoto')?>
                </button>
              ...
              <div class="docs-preview clearfix">
                <div class="img-preview preview-lg" style="width: 320px;height: <?= $ratio['height']?>px;overflow: hidden;"></div>
              </div>
            </div>
          </div>
        </div> 
