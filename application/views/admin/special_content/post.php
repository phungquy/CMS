            ...
            <div class="x_content">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <textarea name="sc_description" id="sc_description"><?= $formDataLang['sc_description']?></textarea>
              ...
              <div class="text-center">
                ...
                *:<code><?= lang('requiredfields')?></code><br>
                ShortCode:<code>[intynets:special_content code=<?= $formData['code_position']?>]</code>
