    ...
    <div class="page-title">
      ...
      <div class="title_left">
        ...
        <h3><?= $title?>
          ...
          <a href="<?= my_library::admin_site()?>category"><button type="button" class="btn btn-success btn-xs"><i class="fa fa-list"></i> <?= lang('list')?></button></a> <?php if (isset($id)): ?><a href="<?= my_library::admin_site()?>category/add"><button type="button" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> <?= lang('categoryadd')?></button></a></h3><?php endif ?>
        ...
        <div class="col-md-8 col-sm-8 col-xs-12">
          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <?php if (isset($formDataLang['category_alias']) && isset($id)): ?>

                <div class="form-inline" style="margin-left: 10px;">

                  <div class="form-group">

                    <label class="control-label" style="text-align: left !important;" for="category_alias"><img src="<?= my_library::base_file().'language/flag_'.$langPost['lang_code'].'.png'?>" class="img-input"> <?= lang('staticlink')?> <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="<?= lang('autoinput')?>"></i>

                    </label>&nbsp;

                    <div>

                      <input type="text" width="50%" class="form-control" name="category_alias" value="<?= $formDataLang['category_alias']?>" style="max-width: 100%;width: 350px;">
          ...
          <div class="x_panel">
            ...
            <div class="x_content">
              ...
              <div class="form-group">
                ...
                <label class="control-label col-md-5 col-sm-5 col-xs-12" for="category_view"><?= lang('view')?></label>

                <div class="col-md-7 col-sm-7 col-xs-12 item">
                  <select class="form-control" name="category_view">
