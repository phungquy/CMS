        ...
        <div class="container">
            <form class="form-horizontal record_reviews_item">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 ">
                        <input type="email" class="form-control" id="er_email" placeholder="Email">
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                        <div class="experience">
                            <select id="er_networth" class="form-control" required="required">
                                <option value="5">USD 600,000 - 800,000</option>
                                <option value="6">USD 800,000 - 1,000,000</option>
                                <option value="7">USD 1,000,000 - 2,000,000</option>
                                <option value="8">&gt; USD 2,000,000</option>
                            </select>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 ">
                        <textarea id="er_note" class="form-control" rows="4"></textarea>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </div>
