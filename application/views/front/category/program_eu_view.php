...
<div class="eb5 eb5_list_menu_main">
    <div class="the-thub_img_title main_thub_img_title">
        <ul>
            <li class="active">
                <a href="#gioithieu">
                    <p class="fs13em mb0">Tại sao bạn nên chọn đầu tư Định Cư Châu Âu ?</p>
                </a>
            </li>
            <li>
                <a href="#loiich">
            ...
            <li>
                <a href="#cacduan">
                    <p class="fs13em mb0">Các dự án Châu Âu</p>
                </a>
            </li>
        </ul>
    </div>
...
<main id="main_down">
    ...
    <div class="eb5">
        <div class="project-eb5" id="cacduan">
            <div class="container">
                <h1 class="color-367a3d text-uppercase text-center mb40 fs25px"><strong>Các dự án</strong></h1>
                <div class="row">
                    <?php if (isset($listProgramEU)): ?>
                        <?php foreach ($listProgramEU as $value): ?>
