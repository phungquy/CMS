...
tinymce.init({selector: 'textarea',height: 300,theme: 'modern',plugins: [
  ...
  ],toolbar1: 'undo redo | insert | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image',toolbar2: 'template | print preview media | forecolor backcolor emoticons | codesample help',templates: [
    {title: 'So sánh Canada', description: 'HTML Canada Table', url: configs.base_url+'public/template/compare-canada.html'},
    {title: 'So sánh EB-5', description: 'HTML EB-5 Table', url: configs.base_url+'public/template/compare-eb5.html'}
