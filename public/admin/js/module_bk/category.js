...
tinymce.init({selector: 'textarea',height: 300,theme: 'modern',plugins: [
    ...
    {title: 'Canada', description: 'HTML Canada', url: configs.base_url+'public/template/canada.html'},
    {title: 'EB-5', description: 'HTML EB-5', url: configs.base_url+'public/template/eb5.html'}
